...
t = sp.Symbol('t')
params = sp.symbols('m1, x_{S1}, y_{S1}, J1, '
                    'm2, y_{S2}, J2, '
                    'm3, y_{S3}, r, J3, '
                    'cB, cZ, g')
m1, xS1, yS1, J1, m2, yS2, J2, m3, yS3, r, J3, cB, cZ, g = params
...
T = 0.5*( m1*(((r*psi_t + xS1 - r*theta_t)**2 + yS1**2)*d_psi_t**2 + 2*r**2*(1 + cos(psi_t))*d_theta_t**2
         ...
         + m3*(r**2 + 2*r*yS3*cos(theta_t) + yS3**2)*d_theta_t**2
         + (J1 + J2)*d_psi_t**2 + J3*d_theta_t**2 )
...
# the equations appear to be incredibly long, but simplification shows that they're almost the same as in
# R.Räbiger - Weiterentwicklung eines Versuchsstandes zur Regelung des Balance-Brett-Systems
# chapter 2.2, page 9#
# equation (2.15) is correct except one plus instead of a minus
# (2.16) and (2.17) are correct